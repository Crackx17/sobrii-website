...
function Section({
  ...
  return (
    <section
      className={`h-screen snap-start flex items-center justify-center px-4 sm:px-6 md:px-8 ${bg} ${className}`}
    >
...
function CountUpNumber({
  ...
  return (
    <span ref={countRef} className="text-4xl sm:text-5xl md:text-8xl font-bold">
      ...
      <div className="relative overflow-hidden">
        ...
        >
          {partners.map((partner, index) => (
            <div
              key={index}
              className="w-1/3 flex-shrink-0 px-4 sm:px-6 md:px-8"
            >
              <div className="bg-white rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg h-20 sm:h-24 md:h-32 flex items-center justify-center">
                <img
                  src={partner.logo}
                  alt={partner.name}
    ...
    <div className="overflow-x-hidden">
      ...
      <Section bg="bg-black text-white">
        <div className="text-center px-4 sm:px-6">
          <h1 className="text-5xl sm:text-6xl md:text-9xl font-bold mb-6 md:mb-8">
            sobrii
          </h1>
          <h2 className="text-base sm:text-lg md:text-2xl font-light mb-8">
            La solution pour une sobriété numérique intelligente et rentable. <br />
            Réduisez l'empreinte carbone, diminuez vos coûts énergétiques et prolongez la durée de vie de vos PC.
          </h2>
          <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6">
            <button
              onClick={scrollToCalculator}
              className="w-full sm:w-auto bg-white text-black px-6 py-4 rounded-full text-sm sm:text-lg font-semibold hover:bg-gray-100 transition-colors"
            >
              Calculer le ROI
            </button>
            <a
              ...
              className="w-full sm:w-auto bg-white text-black px-6 py-4 rounded-full text-sm sm:text-lg font-semibold hover:bg-gray-100 transition-colors text-center"
            >
              Demander une démo
            </a>
          </div>
      ...
      {/* Les Enjeux Section */}
      <Section bg="bg-white">
        <h2 className="text-2xl sm:text-3xl md:text-6xl font-bold mb-6 sm:mb-10 text-center">
          Les Enjeux
        </h2>
        <h3 className="text-base sm:text-lg md:text-2xl font-bold mb-6 sm:mb-10 text-center px-4">
          Gérer efficacement son parc informatique est un défi stratégique pour les
          organisations.
        </h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 px-4 sm:px-6">
          {[...Array(4)].map((_, index) => (
            <div
              key={index}
              className="bg-white p-4 sm:p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-gray-200"
            >
              ...
              <p className="text-sm sm:text-base text-gray-600 text-center">
                {index % 4 === 0 &&
                  "Réduisez les coûts énergétiques grâce à une optimisation intelligente."}
                {index % 4 === 1 &&
                  "Agissez sur la durabilité en réduisant les émissions liées à vos équipements."}
                {index % 4 === 2 &&
                  "Maximisez la performance et la durabilité de vos équipements."}
                {index % 4 === 3 &&
                  "Gardez le contrôle sur vos composants. Anticipez les pannes et réduisez les interruptions."}
              </p>
            </div>
          ))}
        </div>
      ...
      {/* Calculator Section */}
      <Section>
        <div ref={calculatorRef} className="max-w-2xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl md:text-6xl font-bold mb-6 sm:mb-10 text-center">
            Calculer vos économies
          </h2>
          <h3 className="text-base sm:text-lg md:text-2xl font-bold mb-6 sm:mb-10 text-center">
            Hypothèse sur un parc avec 70% de PC Portables avec une durée de vie
            moyenne de 4,5 ans
          </h3>
          <div className="bg-gray-50 p-4 sm:p-6 md:p-8 rounded-3xl shadow-lg">
            ...
            <input
              ...
              className="w-full"
            />
            <div className="text-center text-lg sm:text-xl font-bold mt-2">
...
<Section bg="bg-gray-50">
  <div className="max-w-6xl mx-auto px-4 sm:px-6">
    <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-10 text-center">
      Tarification simple
    </h2>
    ...
    <p className="text-center text-gray-600 mt-6">
      ...
      <Section bg="bg-gray-50">
        <div className="max-w-3xl mx-auto w-full px-4 sm:px-6">
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-8 text-center">
            FAQ
          </h2>
            ...
            {[
              ...
              >
                <div className="p-4 sm:p-6 flex justify-between items-center">
                  <h3 className="text-base sm:text-lg md:text-xl font-bold pr-4">
                    {faq.q}
                  </h3>
                  <ChevronDown
